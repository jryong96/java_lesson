...
import koreaitday17.Word;

public class MyDictionaryV2 {

	public static void main(String[] args) {

		Scanner sc = new Scanner(System.in); //scanner蹂��닔1
		Scanner sc2 = new Scanner(System.in);// scanner蹂��닔2
		List<Word> mywords = new ArrayList<>(); //Word���엯�쓽 List >> mywords �꽑�뼵
		try {
			System.out.println("�뙆�씪�쓣 遺덈윭�삱源뚯슂?y/n : ");
			if(sc2.nextLine().equals("y"))
			// �뙆�씪�뿉�꽌 湲곗〈 �궡�슜�쓣 �씫�뼱�삤怨� 洹� �궡�슜�쓣 mywords�뿉 ���옣
			read(mywords, "C:\\iclass\\�궗�쟾.txt"); //寃쎈줈�뿉 �엳�뒗 �뙆�씪�쓣 �씫�뼱�삤湲�
			else
				System.out.println("�뙆�씪�쓣 �깉濡� 留뚮벊�땲�떎.");
		} // �뙆�씪�뿉�꽌 湲곗〈 �궡�슜 �씫�뼱�삤怨� 洹� �궡�슜�쓣 mywords 由ъ뒪�듃�뿉 ���옣
		catch (FileNotFoundException e1) {
			System.out.println("�씫湲곗쨷�뿉 �삤瑜섍� 諛쒖깮�뻽�뒿�땲�떎." + e1.getMessage());
		}
		String sel, eng, kor;
		int level;
...
//				System.out.println("�떒�뼱�옣 �쟾泥대낫湲� :" + mywords);
		...
		try {
			System.out.println("�뙆�씪�뿉 ���옣�븷源뚯슂?y/n : ");
			if(sc2.nextLine().equals("y")) 
			// mywords 由ъ뒪�듃�쓽 �궡�슜�쓣 �뙆�씪�뿉 ���옣�븯湲�
			save(mywords, "C:\\iclass\\�궗�쟾.txt");
			else
	...
	private static void read(List<Word> mywords, String filename) throws FileNotFoundException{
		...
		while (sc.hasNext()) {
			String temp = sc.nextLine(); //�뙆�씪�뿉�꽌 1以� �씫�뼱�삩 寃� ���옣
			System.out.println(temp.substring(0,temp.indexOf("("))); // 媛앹껜留뚮뱾 �븣 �븘�슂�븳 媛믩쭔 媛��졇�삤湲� �뀒�뒪�듃
				//�쐞�쓽 寃곌낵瑜� 李멸퀬濡� StringTokenizer 濡� word 媛앹껜 留뚮뱾怨�, mywords 由ъ뒪�듃�뿉 異붽��븯湲�.
			//?? 肄붾뵫 �셿�꽦�릺硫� 3踰� �쟾泥대낫湲곕줈 �떎�뻾.
